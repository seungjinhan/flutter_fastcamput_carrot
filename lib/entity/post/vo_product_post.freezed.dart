...
class _$ProductPostImpl implements _ProductPost {
  const _$ProductPostImpl(this.user, this.product, this.content, this.address,
      this.chatCount, this.likeCount, this.created);
  ...
  @override
  String toString() {
    return 'ProductPost(user: $user, product: $product, content: $content, address: $address, chatCount: $chatCount, likeCount: $likeCount, created: $created)';
  }
...
abstract class _ProductPost implements ProductPost {
  const factory _ProductPost(
      ...
      final int chatCount,
      final int likeCount,
      final DateTime created) = _$ProductPostImpl;
