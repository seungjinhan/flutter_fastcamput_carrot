...
class _$SimpleProductPostImpl implements _SimpleProductPost {
  const _$SimpleProductPostImpl(this.id, this.user, this.product, this.title,
      this.address, this.chatCount, this.likeCount, this.created);
  ...
  @override
  String toString() {
    return 'SimpleProductPost(id: $id, user: $user, product: $product, title: $title, address: $address, chatCount: $chatCount, likeCount: $likeCount, created: $created)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, user, product, title,
      address, chatCount, likeCount, created);
...
abstract class _SimpleProductPost implements SimpleProductPost {
  const factory _SimpleProductPost(
      ...
      final int chatCount,
      final int likeCount,
      final DateTime created) = _$SimpleProductPostImpl;
