      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            height30,
            _DescEditor(controller: descriptionController),
          ],
        ).pSymmetric(h: 15),
      ),
...
class _TitleEditor extends StatelessWidget {
  ...
  _TitleEditor({required this.controller});
...
class _PriceEditor extends StatefulWidget {
  ...
  _PriceEditor({required this.controller});
...
class _DescEditor extends StatelessWidget {
  ...
  _DescEditor({required this.controller});
